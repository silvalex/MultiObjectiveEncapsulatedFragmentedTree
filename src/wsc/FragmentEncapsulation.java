...
public class FragmentEncapsulation {
	...
	public static void main(String[] args) {
		...
		File dir = new File("fragmentFiles");
		...
		File encapsulatedFile = new File("encapsulated.stat");
		try {
		...
		try {
			FileWriter writer = new FileWriter(new File("encapsulationTime.txt"));
